...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "ai-agent-knowledge", content: `${siteUrl}/llms.txt` },
      { name: "ai-content-declaration", content: `llms-txt=${siteUrl}/llms.txt` },
    ],
    links: [
      { rel: "alternate", hrefLang: "en", href: siteUrl },
      { rel: "help", href: `${siteUrl}/llms.txt`, type: "text/markdown", title: "LLMs.txt AI Agent Knowledge Graph" },
      { rel: "describedby", href: `${siteUrl}/llms-full.txt`, type: "text/markdown", title: "Comprehensive AI Knowledge Document" },
      { rel: "stylesheet", href: appCss },
      { rel: "icon", href: "/favicon.ico" },
      { rel: "icon", href: `${siteUrl}/favicon.ico`, sizes: "48x48" },
      { rel: "icon", href: "/favicon.png", type: "image/png" },
      { rel: "icon", href: `${siteUrl}/favicon.png`, type: "image/png", sizes: "48x48 192x192 512x512" },
      { rel: "shortcut icon", href: `${siteUrl}/favicon.ico` },
      { rel: "apple-touch-icon", href: `${siteUrl}/favicon.png`, sizes: "180x180" },
