...
export const Route = createFileRoute("/journal")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Explore the Studio Young Designs journal. Read about modular kitchen guides in Bangalore, bespoke wardrobe design, timeless interior trends, and expert turnkey execution." },
      { name: "keywords", content: "Bangalore interior design blog, modular kitchen tips, luxury wardrobe ideas, turnkey interiors Bangalore, home styling tips" }
    ],
  }),
...
const posts: JournalPost[] = [
  {
    ...
    excerpt: "From layout planning and material selection to ventilation and local climate considerations, explore our essential guide to building a luxury modular kitchen.",
    date: "June 15, 2026",
    readTime: "6 min read",
    category: "guides",
    image: svcKitchen,
    keywords: ["modular kitchen Bangalore", "kitchen design ideas", "luxury kitchens", "kitchen layouts"],
    content: [
  ...
  },
  {
    ...
    excerpt: "Discover the material palette that defines timeless luxury. Learn how we combine raw organic textures with polished elements to create rich, balanced environments.",
    date: "May 28, 2026",
    readTime: "5 min read",
    category: "materials",
    image: p3,
    keywords: ["luxury interiors", "natural stone", "walnut wood furniture", "brass details in design"],
    content: [
  ...
  },
  {
    ...
    excerpt: "Your wardrobe is more than just storage; it is a personal boutique. Explore how custom walk-in closets and glass wardrobes add functional luxury to bedrooms.",
    date: "April 18, 2026",
    readTime: "4 min read",
    category: "guides",
    image: svcWardrobe,
  ...
  },
  {
    ...
    excerpt: "Navigating a home renovation can be overwhelming. We break down the differences in cost, coordination, quality, and peace of mind between turnkey solutions and contractors.",
    date: "March 10, 2026",
    readTime: "7 min read",
    category: "design-tips",
    image: svcComplete,
    keywords: ["turnkey interior designers Bangalore", "interior contractor vs designer", "home renovation guide"],
    content: [
          ...
          <div className="mb-16 flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
            <div>
              <Reveal3D rotateX={10}>
                ...
                <SplitHeading text="Considered insights." className="text-4xl text-charcoal md:text-5xl" />
              </Reveal3D>
            </div>
        ...
        {selectedPost && (
          ...
          >
            ...
            >
              ...
              >
                <span className="inline-block font-sans text-xs uppercase tracking-[0.2em] mr-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">Close</span>
              ...
              <article className="space-y-8 mt-6">
                ...
                <div className="pt-8 border-t border-cream/10">
                  <div className="flex flex-wrap gap-2 items-center">
                    <span className="text-xs text-cream/40 uppercase tracking-widest mr-2">Tags:</span>
